...
namespace CSBaseLib
{
    ...
    [MessagePackObject]
    public class PKTResUserScoreUpdate // 응답 패킷도 필요합니다
    {
        [Key(0)]
        public string UserID;
        [Key(1)]
    ...
    [MessagePackObject]
    public class PKTReqUserScoreGet
    {
        [Key(0)]
        public string UserID;
    }
    ...
    // 점수 요청에 대한 서버 응답 패킷
    [MessagePackObject]
    public class PKTResUserScoreGet
    {
        [Key(0)]
        public short Result;
    ...
    public class PKTReqUserScoreAdd
    {
        ...
        public string UserID;
        [Key(1)]
        public int AddScore; // 추가할 점수량
    }

    [MessagePackObject]
    public class PKTResUserScoreAdd // 최종 점수를 받아올 응답
    {
        [Key(0)]
        public short Result;
        [Key(1)]
        public int FinalScore; // 서버가 계산한 최종 점수
    }
}
